...
<form name="bminput"method="post" id="inputfile" action="/JackPot/myBmFormModify.jp?bm_num=${bm_num }" enctype="multipart/form-data"  onSubmit="return checkIt();">
                       ...
                       <tr id="Termless" style=" display: ;" >
                        ...
                        <tr id="rAlarmTR">
  						...
  						<tr style=" height: 500px;">
                            ...
                            <td colspan="3">
                                <div>			
									<textarea class="ckeditor" cols="1" id="bm_content"  value="${bmdto.bm_content}"  name="bm_content" rows="15"></textarea>
                                </div>
                   	 	</tr>
                   	 	<!--파일 부분 -->	
