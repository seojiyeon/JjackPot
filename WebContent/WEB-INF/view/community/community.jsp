...
<link href="/JackPot/css/community.css?ver=17" rel="stylesheet" type="text/css">
...
style="position:relative; top:0; left:0;" dir="ltr">
				...
				<li data-submenu="allList" class="current">
						...
						<a href="#" class="sidebar-nav-menu" onclick="layer_open('layer1');return false;">게시물 등록</a>
					</li>
				<li id="commGroupTree" data-submenu="commGroup" data-emitem="addr.organogram">
					<a href="community.jp" class="sidebar-nav-menu">최근 게시판</a>
